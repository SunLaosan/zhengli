<?php
/**
 * 链接地址http://www.jb51.net/article/45951.htm
 * 共有两个方法 checkPhoneOne checkPhoneTwo
 */
class Index extends Controller{

	public function checkPhoneOne()
	{
		/*移动端判断*/
	    ...
	    {
	    	$this->redirect('http://www.yhtshiguan.com/index/m_ussg1.html');
	    ...
	    { 
	  	...
	  	$this->redirect('http://www.yhtshiguan.com/index/p_ussg.html');
		
	}

	function checkPhoneTwo($ignore_cookie = false)
	{
